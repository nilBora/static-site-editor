...
<title>Slidit - free website template</title>
...
<div id="tooplate_wrapper">
	<div id="tooplate_header">
    	<div id="site_title">
        	<a href="index.html"><img src="images/tooplate_logo.png" alt="Logo" /><span>Free HTML CSS Template</span></a>
        </div>
    </div> <!-- END of header -->
    <div id="tooplate_middle"><span class="middle_bottom_frame"></span>
        ...
        <div class="list_carousel">
            <ul id="foo2">
                <li><a href="#"><img src="images/slider/01.jpg" alt="Image" /></a></li>
                <li><a href="#"><img src="images/slider/03.jpg" alt="Image" /></a></li>
    ...
    <div id="tooplate_main"><span class="main_frame main_top_frame"></span><span class="main_frame main_bottom_frame"></span>
    	<div class="content_wrapper content_mb_30">
        	<div class="col_3 service_home">
            	<h2><img src="images/onebit_24.png" alt="Image" /> Lorem Ipsum Dolor Sum</h2>
            ...
            <div class="col_3 service_home">
            	<h2><img src="images/onebit_26.png" alt="Image" /> Integer Mollis Venetis</h2>
            ...
            <div class="col_3 no_margin_right service_home">
            	<h2><img src="images/onebit_16.png" alt="Image" /> Nulla Pharetra Turpis</h2>
        ...
        <div class="col_2 no_margin_right">
			...
			<div class="testimonial_carousel">
                <ul id="foo3">
                    <li>
                    	<p class="testimonial">
                        	Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam turpis enim, feugiat nec euismod et, mattis a ipsum. Aliquam erat volutpat.
						</p>
                        <span class="name"><strong>John</strong> - <a href="#">tooplate CEO</a></span>
                    </li>
                    <li>
                    	<p class="testimonial">
                        	Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam turpis enim, feugiat nec euismod et, mattis a ipsum. Aliquam erat volutpat.
						</p>
                        <span class="name"><strong>Moon</strong> - <a href="#">tooplate Admin</a></span>
                    </li>
                    <li>
                    	<p class="testimonial">
                        	Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam turpis enim, feugiat nec euismod et, mattis a ipsum. Aliquam erat volutpat.
						</p>
                        <span class="name"><strong>Cindy</strong> - <a href="#">tooplate Staff</a></span>
                    </li>
                    <li>
                    	<p class="testimonial">
                        	Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam turpis enim, feugiat nec euismod et, mattis a ipsum. Aliquam erat volutpat.
						</p>
                        <span class="name"><strong>George</strong> - <a href="#">tooplate Chief</a></span>
                    </li>
                    <li>
                    	<p class="testimonial">
                        	Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam turpis enim, feugiat nec euismod et, mattis a ipsum. Aliquam erat volutpat.
						</p>
                        <span class="name"><strong>Van</strong> - <a href="#">tooplate Leader</a></span>
                    </li>
                </ul>
    
                <a id="test_prev" class="test_slider_nav_button test_prev" href="#">&lt;</a>
                <a id="test_next" class="test_slider_nav_button test_next" href="#">&gt;</a>
            </div>
        </div>	
    </div>
	...
	<div id="tooplate_footer">
    	<div class="col_5">
         ...
         <div class="col_25">
            <h4>News</h4>
            <div class="news_list">
                <img src="images/tooplate_image_01.jpg" alt="Image"  class="img_fl img_border img_border_s" />
                <a href="#">Cras mi lectus tempus vitae</a>
                <p>Ut vitae luctus mi. Donec ligula dolor, lobortis ac porttitor sed, aliquam non orci.</p>
                <div class="clear"></div>
            </div>           
            <div class="news_list">
                <img src="images/tooplate_image_02.jpg" alt="Image" class="img_fl img_border img_border_s" />
                <a href="#">Cras dignissim volutpat sem id</a>
                <p>Donec vitae augue ut sem cursus aliquet rhoncus vel quam. </p>
              <div class="clear"></div>
            </div>   
             <div class="news_list">
                <img src="images/tooplate_image_03.jpg" alt="Image" class="img_fl img_border img_border_s" />
        ...
        <div class="col_25 no_margin_right">
